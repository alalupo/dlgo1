...
class SgfReadingTest(unittest.TestCase):
    ...
    def test_npy_saving(self):
        ...
        feature_shape = (164, 11, 19, 19)  # size = 651244, round(features.nbytes / 1000000, 2) = 5.21 MB
        processor.read_zip(zip_file_name, data_file_name, game_list, data_type, num_samples)
